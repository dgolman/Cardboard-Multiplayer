...
#define DLL_EXPORT
    ...
    DECL_USER_FUNC(SetDefaultProfile);
    DECL_USER_FUNC(SetUnityVersion);
...
DLL_EXPORT void RegisterMonoModules()
{
    ...
    REGISTER_USER_FUNC(SetDefaultProfile);
    REGISTER_USER_FUNC(SetUnityVersion);
